...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/stephanieleal/Box/Leal Lab/Zoom/Zoom Tasks/Zoom Face-Name Task/test1_faces.py',
...
instrText = visual.TextStim(win=win, name='instrText',
    text='Have you seen this EXACT face during the first part of the experiment?\n\nYou will see a scale at the bottom of each image. \n\nClick the tick mark above each option (Same exact face, New or different face) to lock in your response. \n\nYou have 3 seconds to respond while the face is on the screen. Click anywhere to begin.\n',
    font='Arial',
...
rating = visual.RatingScale(win=win, name='rating', marker='circle', size=1, pos=[0.0, -0.8], choices=['Same Exact Face', 'New or Different Face'], tickHeight=2.5, singleClick=True, markerStart='.5', showAccept=False)
...
trials = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('test1_faces.xlsx'),
...
for thisTrial in trials:
    ...
    rating.reset()
    # keep track of which components have finished
    trialComponents = [ISI, image, rating]
