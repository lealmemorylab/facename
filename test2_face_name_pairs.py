...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/stephanieleal/Box/Leal Lab/Zoom/Zoom Tasks/Zoom Face-Name Task/test2_face_name_pairs.py',
...
instrText = visual.TextStim(win=win, name='instrText',
    text='Is the name below each face correct?\n\nYou will see a scale at the bottom of each image. \n\nClick the tick mark above each option (Same Exact Name, New or Different Name) to lock in your response.\n\nYou will have 4 seconds to respond while the face is on the screen. Click anywhere to begin.',
    font='Arial',
...
rating = visual.RatingScale(win=win, name='rating', marker='circle', size=1.0, pos=[0.0, -0.8], choices=['Same Exact Name', 'New or Different Name'], tickHeight=2.5, singleClick=True, markerStart='center', showAccept=False)
...
trials = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('test2_face_name_pairs.xlsx'),
